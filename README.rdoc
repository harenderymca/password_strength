...
//= require password_strength
  make sure to add this line after //= require jquery and before //= require tree AND should be in seprate line
...
<div>      <!--THIS DIV SHOULD ONLY CONTAIN THE PASSWORD FIELD-->
